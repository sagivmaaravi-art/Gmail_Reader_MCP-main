...
chat = client.chat.create(
    model="grok-4.20-beta-latest-non-reasoning",  # reasoning model
...
* **Model**: Use reasoning models like `grok-4.20-beta-latest-non-reasoning` for better code generation
